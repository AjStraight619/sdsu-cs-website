...
export default async function AdminDashboard({
  ...
  const getCourseTitle = (course: string): string | boolean => {
  ...
  return (
    <div className="min-h-screen flex flex-col p-12 space-y-12 pt-32 container overflow-auto">
      <section className="flex sm:flex-row items-center sm:items-start sm:justify-between flex-col justify-center gap-x-2">
